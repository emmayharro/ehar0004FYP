function Gen_PM_MQAM_RRCshaped_multiband_SBS(M,Baud,DACrate,Beta,Att_stop,Nsc,sep_fact,dc_fact,PE_on)
...
save(namefile,'TxX','TxY','dataX','dataY','synch','rrc_filter','TxX_bits','TxY_bits','Beta','Att_stop','Baud','M','Nsc','sep_fact');
