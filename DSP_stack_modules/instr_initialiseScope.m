...
elseif strcmp(scope,'UXRloan')==1
    if strcmp(interface,'TCPIP')==1
        Leader.Addr = 'TCPIP0::KEYSIGH-V5MKPEQ::inst0::INSTR'; %UXR scope address (TCPIP remote)
    elseif strcmp(interface,'USB')==1
        Leader.Addr = 'USB0::10893::36865::MY59160101::0::INSTR'; %UXR scope address (USB remote)
    elseif strcmp(interface,'local')==1
        Leader.Addr = 'TCPIP0::localhost::inst0::INSTR'; % Leader visa address
    else
        error('interface not defined')
